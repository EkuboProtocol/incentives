                                                       ...
                                                       AS (SELECT psdp.pool_key_hash                                                 AS pool_key_hash,
                                                                  ...
                                                                  ROUND(
                                                                          GREATEST(EXTRACT(
                                                                                           EPOCH FROM (
                                                                                      LEAST(
                                                                                              COALESCE(psdp.next_update_time, ($1::timestamptz + INTERVAL '1 day')),
                                                                                              COALESCE(
                                                   ...
                                                   position_depth_seconds AS (SELECT pool_key_hash,
                                                                                     ...
                                                                                     SUM(
                                                                                             ...
                                                                                             (ticks_in_range_of_25th_percentile_volatility *
                                                                                              ...
                                                                                              0.301 +
                                                                                              ticks_in_range_of_2_volatility *
                                                                                              0.271 +
                                                                                              ticks_in_range_of_3_volatility *
                                                                                              0.043) / position_width
